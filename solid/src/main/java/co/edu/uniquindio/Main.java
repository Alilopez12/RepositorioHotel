...
public class Main {
    public static void main(String[] args) {
        ...
        String dni = JOptionPane.showInputDialog(null,
                "Ingrese el DNI del cliente a actualizar o mostrar el registro de estadia:",
                "Actualizar Información del Cliente o Mostrar Registro de estadia", JOptionPane.PLAIN_MESSAGE);

        /*
         * Muestra un diálogo para que el usuario elija entre actualizar la información del cliente o mostrar el registro de consumo.
         *
         * @returns {int} - La opción seleccionada por el usuario: 0 para actualizar información, 1 para mostrar el registro de consumo.
         */
